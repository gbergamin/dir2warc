...
* both html page and text page created, are available inside the WARC. 
  ...
  * the txt can be used as a sort of map and/or ledger of the content included in WARC: for every file it links new identifiers with the old ones and contains also the md5 hash
